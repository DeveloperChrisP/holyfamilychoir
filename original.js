...
function Liturgy(date, occasion, year, selector, hymn, instrumental, psalm, alleluia) {
    this.date = date;
    ...
    this.alleluia = grabAlleluiaObject(alleluia);
...
function AlleluiaVerse(ref, line1, line2) {
    this.ref = ref;
    this.line1 = line1;
    this.line2 = line2;
    allAlleluiaVerses.push(this);
}
...
function grabAlleluiaObject(alleluiaRef) {
    //return array of hymn objects (up to 8) depending on how many are requested in 'new liturgy'

    if (alleluiaRef !== undefined && alleluiaRef !== "") {
        // psalmNumber.forEach(input => {
        let alleluia = allAlleluiaVerses.filter(x => (x.ref == alleluiaRef))[0]
        // }
...
new Hymn("Hail Redeemer King divine", 320, "", "", "https://www.youtube.com/embed/DJpcPr09O60?si=jR2LHdFjeLxHYGwY")
...
new Hymn("Lead kindly light", 961, "", "", "https://www.youtube.com/embed/8fNjEgbsNmI?si=y1lmr0W-B810vtiZ")
...
new Liturgy(new Date("10 May 2026"), "6th Sunday of Easter", "A", "Julian", ["God is love, his the care", "Bread of life", "O come and mourn with me awhile", "Tell out my soul"], "", "Cry out with joy to God, all the earth.")
new Liturgy(new Date("17 May 2026"), "7th Sunday of Easter", "A", "Julian", ["Love divine, all loves excelling", "Crown him with many crowns", "Living Lord", "As I kneel before you"], "", "I believe I shall see the Lord's goodness in the land of the living.", "John 14:18")

new Liturgy(new Date("24 May 2026"), "Pentecost Sunday", "A", "Julian", ["Shine Jesus shine", "Come down O love divine", "Breathe on me, Breath of God", "Hail Queen of heaven"], "", "Send forth your spirit, O Lord, and renew the face of the earth.", "unknown")

new Liturgy(new Date("31 May 2026"), "Trinity Sunday", "A", "Julian", ["Eternal father, strong to save", "Praise to the Lord, the almighty", "Lead us heavenly father", "Immortal invisible"], "", "To be praised and highly exalted for ever!", "Cf. Revelation 1:8")
new Liturgy(new Date("7 Jun 2026"), "Corpus Christi", "A", "Julian", ["Guide me O thou Great redeemer", "Jesus my Lord, my God, my all", "Godhead here in hiding", "Sing of Mary, pure and lowly"], "", "O Jerusalem, glorify the Lord!", "John 6:51")
...
new Liturgy(new Date("14 Jun 2026"), "11th Sunday in Ordinary Time", "A", "Julian", ["Our God Reigns", "Here we bring you", "Soul of my saviour", "Christ be our light"], ["God has chosen me"], "We are his people, the sheep of his flock.", "Mark 1:15")
new Liturgy(new Date("21 Jun 2026"), "12th Sunday in Ordinary Time", "A", "Julian", ["My God accept my heart this day", "Faith of our fathers", "Lead kindly light", "I'll sing a Hymn to Mary"], ["Do not be afraid", "O the word of my Lord"], "In your great mercy, answer me, O Lord.", "John 15:26b")
new Liturgy(new Date("28 Jun 2026"), "13th Sunday in Ordinary Time", "A", "Julian", ["Hail Redeemer, King Divine", "Dear Lord and father of mankind", "O sacred heart", "Follow me, follow me"], ["Taste and see"], "From all my terrors the Lord set me free.", "Matthew 16:18")
new Liturgy(new Date("5 Jul 2026"), "14th Sunday in Ordinary Time", "A", "Chris", ["Sing of the Lord's Goodness", "The Servant King", "O let all who thirst", "Sing of Mary, Pure and lowly"], ["Taste and see"], "I will bless your name for ever, my God and king.", "Matthew 11:25")
new Liturgy(new Date("12 Jul 2026"), "15th Sunday in Ordinary Time", "A", "Chris", ["Love divine, all loves excelling", "I will be with you", "We Come to your feast", "O the word of my Lord", "Unless a grain of wheat", "Here I am, Lord"], "", "Some seed fell into good soil and yielded its fruit.", "unknown2")
new Liturgy(new Date("19 Jul 2026"), "16th Sunday in Ordinary Time", "A", "Chris", ["Gather us in", "All people that on earth do dwell", "Be still for the presence of the Lord", "O Mother blest"], ["O Lord, hear my prayer", "Amazing Grace"], "O Lord, you are good and forgiving.", "Matthew 11:25")
new Liturgy(new Date("26 July 2026"), "17th Sunday in Ordinary Time", "A", "Chris", ["Seek ye first", "Be thou my vision", "O the Love of my Lord is the essence", "Hail, Queen of heaven"], ["Teach me, O God"], "O Lord, how I love your law!", "Matthew 11:25")
new Liturgy(new Date("2 Aug 2026"), "18th Sunday in Ordinary Time", "A", "Chris", ["Alleluia Sing to Jesus", "Bread of life", "I am the bread of life", "Holy Virgin, by God's decree"], "", "You open your hand and fulfil us, O Lord.", "Matthew 4:4b")
...
new Liturgy(new Date("16 Aug 2026"), "The Assumption of the Blessed Virgin Mary", "A", "Chris", ["Holy is his name", "My God loves me", "Mary immaculate, star of the morning", "Immaculate Mary"], ["Magnificat"], "On your right stands the queen in gold of Ophir")
new Liturgy(new Date("23 Aug 2026"), "21st Sunday in Ordinary Time", "A", "Chris", ["All my hope on God is founded", "Praise to the Lord, the Almighty", "Be still for the presence of the Lord", "Holy Virgin, by God's decree"], ["Out of Darkness", "Bread of life", "The summons"], "O Lord, your merciful love is eternal; discard not the work of your hands.")
...
new Liturgy(new Date("6 Sept 2026"), "23rd Sunday in Ordinary Time", "A", "Chris", ["Gather us in", "Brother, sister let me serve you", "This is my body", "Sing of Mary, pure and lowly"], ["Bread of life"], "O that today you would listen to his voice! ‘Harden not your hearts.’")
...
function psalmOrNot() {
    ...
    if (document.querySelector(".flex-container button.hymnsTitle").classList.contains("selected") == true) {
        ...
        const element = document.getElementById("psalm0");
...
function addPsalm(psalm, insertHere, beforeThis) {
    let psalmCount = document.querySelectorAll("details.psalm").length;
    ...
    if (beforeThis !== undefined) {
        document.querySelector(insertHere).insertBefore(psalmDetails, document.querySelector(beforeThis));
    } else {
        document.querySelector(insertHere).append(psalmDetails);
    }

    if (psalm.img !== undefined && psalm.img !== "") {
    ...
    // console.log(document.querySelector(`psalmIMG${psalmCount}`));

    if (psalm.pdf !== undefined && psalm.pdf !== "") {
    ...
    if (psalm.audio !== undefined && psalm.audio !== "" && typeof psalm.audio == "object") {
    ...
    if (psalm.audio !== undefined && psalm.audio !== "") {
        ...
        mediaPlayer.id = `mediaPlayer${psalmCount}`;
        if (typeof psalm.audio == "string") {
            mediaPlayer.innerHTML = `             
                        <h3 class="mediaPlayer__title">Audio Player</h3>
                        <div class="flexContainer">
                            <div id="mediaPlayer__light${psalmCount}" class= "melody selected"></div>
                            <h4 class=mediaPlayer__description id="mediaPlayer__description${psalmCount}">Psalm ${psalm.number} - Melody</h4>
                        </div>
                        <div class="mediaPlayer__audioDiv">
                            <audio controls preload="metadata" src="${psalm.audio}" class="mediaPlayer__audio"></audio>
                        </div>`
        } else {
            mediaPlayer.innerHTML = `             
                        <div class="container">
                        ...
                        <div class="flexContainer">
                            <div id="mediaPlayer__light${psalmCount}" class= "${Object.keys(psalm.audio)[0].toLowerCase()} selected"></div>
                            <h4 class=mediaPlayer__description id="mediaPlayer__description${psalmCount}">Psalm ${psalm.number} - ${Object.keys(psalm.audio)[0]}</h4>
                        </div>
                        <div class="mediaPlayer__audioDiv">
                            <audio loop=true class=psalmAudio id=psalmAudio${psalmCount} controls preload="metadata" src="${Object.values(psalm.audio)[0]}" class="mediaPlayer__audio"></audio>
                        </div>
                        <ul id = "audioPartContainer${psalmCount}" class = "product__audioCategory">
        ...
        if (typeof psalm.audio == "object") {
            ...
            <button class = "audioSelection">${property}</button>`
                document.querySelector(`#audioPartContainer${psalmCount}`).append(part)
            }
            document.getElementById(`audioPartContainer${psalmCount}`).addEventListener("click", (e) => {
                const objKey = e.target.closest('button').textContent;


                // console.log(document.getElementById(`psalmAudio${psalmCount}`));

                e.target.closest('.product__mediaPlayer').querySelector('audio').setAttribute("src", psalm.audio[objKey]);
                e.target.closest('.product__mediaPlayer').querySelector('.mediaPlayer__description').innerText = `Psalm ${psalm.number} - ${objKey}`;
...
wrapper.querySelector(".liturgyContents.hymns.selected").addEventListener("click", function () {
    allHymns = originalHymns;
    if (nextLiturgy[0].instrumental == undefined) { allHymns = (nextLiturgy[0].hymn) } else {
...
function grabHymnObject(hymnTitleArray) {
    ...
    if (hymnTitleArray !== undefined && hymnTitleArray !== "") {
        var hymns = [];
