...
var count = 0;
function MassSetting(title,titleClass,contents,vocalParts,sheetMusic,video){
    this.title = title;
...
var massSetting1 = new MassSetting ("Silent Night","SilentNight",
    ["gloria"],
...
// var massSetting2 = new MassSetting ("Dan Schutte Mass","Schutte",
...
document.querySelector(".leftSmall").addEventListener("click", leftclick);
...
document.querySelector(".rightSmall").addEventListener("click", rightclick);  
    function rightclick (){
    clock++;
...
contentsContainer.addEventListener("click", function (){
    ...
    var filename = "./audio/" + mass[clock].titleClass + "-" + partTitle + ".mp3";
...
//    console.log(filename);
    switch (true) {
        ...
        case event.target.id == "title":
            ...
            document.querySelector("iframe").setAttribute("href", "");
        ...
        case containsClass.contains("gloria"):
            ...
            document.querySelector(".audioSelector > h4 a").textContent = "Gloria - Sheet Music";
            document.querySelector(".audioSelector > h4").setAttribute("id", gloria);
            document.querySelector(".audioSelector > h4 a").setAttribute("href", mass[clock].sheetMusic);
